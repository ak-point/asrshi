...
d2r = Math.PI/180;
r2d = 180/Math.PI;
var zn = ["মেষ","বৃষ","মিথুন","কৰ্কট","সিংহ","কন্যা","তুলা","বৃশ্চিক","ধনু","মকৰ","কুম্ভ","মীন"];
var wd = ["দেওবাৰ","সোমবাৰ","মঙলবাৰ","বুধবাৰ","বৃহস্পতিবাৰ","শুক্ৰবাৰ","শনিবাৰ"];
var range = [1,31,0,0,-3000,4000,0,23,0,59,-12,12,0,59];
var naks = ["অশ্বিনী","ভৰণী","কৃত্তিকা","ৰোহিনী","মৃগশিৰা","আর্দ্রা","পুনর্বসু","পুষ্যা","অশ্লেষা","মঘা","পূর্ব ফালগুনী","উত্তৰ ফালগুনী","হস্তা","চিত্রা","স্বাতী","বিশাখা","অনুৰাধা","জ্যেষ্ঠা","মুলা","পূর্বাষাঢ়া","উত্তৰষাঢ়া","শ্রবণা","ধনিষ্ঠা","শতভিষা", "পূৰ্ব-ভাদ্রপদ","উত্তৰ-ভাদ্রপদ","ৰেৱতী"];
var tith =["শুক্লা প্রতিপদ","শুক্লা দ্বিতীয়া","শুক্লা তৃতীয়া","শুক্লা চতুর্থী","শুক্লা পঞ্চমী","শুক্লা ষষ্ঠী","শুক্লা সপ্তমী","শুক্লা অষ্টমী","শুক্লা নবমী","শুক্লা দশমী","শুক্লা একাদশী","শুক্লা দ্বাদশী","শুক্লা ত্রয়োদশী","শুক্লা চতুর্দশী","পূর্ণিমা","কৃষ্ণ প্রতিপদ","কৃষ্ণ দ্বিতীয়া","কৃষ্ণ তৃতীয়া","কৃষ্ণ চতুর্থী","কৃষ্ণ পঞ্চমী","কৃষ্ণ ষষ্ঠী","কৃষ্ণ সপ্তমী","কৃষ্ণ অষ্টমী","কৃষ্ণ নবমী","কৃষ্ণ দশমী","কৃষ্ণ একাদশী","কৃষ্ণ দ্বাদশী","কৃষ্ণ ত্রয়োদশী","কৃষ্ণ চতুর্দশী","অমাবস্যা"];
var kar = [ "Bawa", "Balava", "Kaulava", "Taitula", "Garaja", "Vanija", "Vishti", "Sakuna", "Chatushpada", "Nagava", "Kimstughana"];
var yog = ["বিষ্কম্ভ","প্রীতি","আয়ুষ্মান","সৌভাগ্য","শোভন","অতিগণ্ড","সুকর্মা","ধৃতি","শূল","গণ্ড","বৃদ্ধি","ধ্রৰুব(Dhruva)","ব্যাঘাত","হর্ষণ","বজ্র","সিদ্ধি","ব্যতিপাত","বৰিয়ান","পৰিঘ","শিব","সিদ্ধ","সাধ্য","শুভ","শুক্ল","ব্রহ্মা","ইন্দ্র","বৈধৃতি"];
